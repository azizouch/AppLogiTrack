...
export function ColisAnnules() {
  ...
  const fetchColis = useCallback(async (isRefresh = false) => {
    try {
      ...
      // Get colis with status "Annulé" - filter by current livreur if user is livreur
              ...
              <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                ...
                <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      Filtrez les colis annulés par recherche, livreur et tri
                    </SheetDescription>
                  </SheetHeader>
