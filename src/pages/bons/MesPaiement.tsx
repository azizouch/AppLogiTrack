...
import { Plus, Search, FileText, CreditCard, RefreshCw, Eye, Download, FileSpreadsheet } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <div className="relative w-full">
          ...
          <Input placeholder="Rechercher un bon de paiement par numéro ou statut" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10 w-full" />
        </div>
      </div>
