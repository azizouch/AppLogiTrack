    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <Input
          ...
          className={`pl-10 ${query ? 'pr-10' : 'pr-4'} py-2 w-full bg-white dark:bg-[hsl(222.2,84%,4.9%)] border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 text-sm ${isMobile ? 'py-3' : ''}`}
